...
$isave = (empty($stationid)) ? '<img src="images/icon-save.png" style="cursor:pointer;margin-bottom:-4px;" title="Save This Net Control" alt="Save This Net Control" width=16 border=0 onclick="getGeoLoc();setNetControl(sid,gps,iid);this.src=\'icon-check.png\';this.style.cursor=\'default\';this.onclick=\'\';">':'<img src="images/icon-check.png" style="margin-bottom:-4px" title="Net Control Saved" alt="Net Control Saved" width=16 border=0>'
?>
...
<tr><th id=log_date colspan=2>ARES-LAX Comms Log</th><th align=left colspan=7><div style="display:inline;color:grey;font-size:13px;text-align:center;">Local Timestamp:<br><?=date("Y-m-d H:i")?></div><div style="margin-top:-10px;float:right;">Net&nbsp;Control:&nbsp;<input type=text size=10 name=stationid id=stationid placeholder="Station ID" class="topknot" onfocus="this.style.backgroundColor='yellow'" onblur="this.style.backgroundColor='white';sid=this.value;" value="<?=$stationid?>">&nbsp;<input type=hidden id=stationgeo><!--input type=text size=18 name=stationloc id=stationloc placeholder="Station Location" class="topknot" value="<?=$stationloc?>" onfocus="getGeoLoc()">&nbsp;--><input type=hidden name=incidentid id=incidentid value="<?=$incidentid?>"><input type=text size=20 name=incidentname id=incidentname placeholder="Which Incident?" class="topknot" value="<?=$incidentname?>" onfocus="this.style.backgroundColor='white';this.select();">&nbsp;<?=$isave?></div></th></tr>
