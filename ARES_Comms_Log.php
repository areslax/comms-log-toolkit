...
<<<<<<< HEAD
<tr><th id=log_date colspan=2>ARES-LAX Comms Log</th><th align=left colspan=7><div style="display:inline;color:grey;font-size:13px;text-align:center;">Local Timestamp:<br><?=date("Y-m-d H:i")?></div><div style="margin-top:-10px;float:right;">Net&nbsp;Control:&nbsp;<input type=text size=10 name=stationid id=stationid placeholder="Station ID" class="topknot" onfocus="this.style.backgroundColor='yellow'" onblur="this.style.backgroundColor='white';sid=this.value;setNetControl(this.value);" value="<?=$stationid?>">&nbsp;<input type=hidden id=stationgeo><input type=text size=18 name=stationloc id=stationloc placeholder="Station Location" class="topknot" value="<?=$stationloc?>" onfocus="getGeoLoc()">&nbsp;<input type=hidden name=incidentid id=incidentid value="<?=$incidentid?>"><input type=text size=20 name=incidentname id=incidentname placeholder="Which Incident?" class="topknot" value="<?=$incidentname?>" onfocus="this.style.backgroundColor='white';this.select();"></div></th></tr>
=======
<tr><th id=log_date colspan=2>ARES-LAX Comms Log</th><th align=left colspan=7><div style="display:inline;color:grey;font-size:13px;text-align:center;">Local Timestamp:<br><?=date("Y-m-d H:i")?></div><div style="margin-top:-10px;float:right;">Net&nbsp;Control:&nbsp;<input type=text size=10 name=stationid id=stationid placeholder="Station ID" class="topknot" onfocus="this.style.backgroundColor='yellow'" onblur="this.style.backgroundColor='white';sid=this.value;setNetControl(this.value);" value="<?=$stationid?>">&nbsp;<input type=text size=18 name=stationloc id=stationloc placeholder="Station Location" class="topknot" value="<?=$stationloc?>">&nbsp;<input type=hidden name=incidentid id=incidentid value="<?=$incidentid?>"><input type=text size=20 name=incidentname id=incidentname placeholder="Which Incident?" class="topknot" value="<?=$incidentname?>" onfocus="this.style.backgroundColor='white';this.select();"></div></th></tr>
>>>>>>> e8c33dad0bd19cc606f6d6e81d7c1396c9fc9c1c
...
if (empty($grab)) {
?>
<tr id=row0 valign=top><th id=rid0><input type=hidden name=ids[] value=0><input type=hidden name=msgstatus_0 id=msgstatus0 value=''>0</th><td><input type=text size=20 name=ts_0 id=ts0 onfocus="hiliteme(0)" onblur='getTimestamp(this.id);disableblur(this);' placeholder='TAB to Set'></td><td><select name=rxtx_0 class='px40' onfocus="hiliteme(0)"><option>Rx</option><option>Tx</option><option>Comment</option></select></td><td><input type=text name=loc_0 id=loc0 class='location' onfocus="hiliteme(0)" placeholder="Tac Call"></td><td><select name=typ_0 id=typ0 class="typdd px80" onfocus="hiliteme(0)" onchange="checkType(this[this.selectedIndex].value,'loc0',0,encodeURIComponent(this.form.incidentid.value),this.form.stationid.value);"><!--$typlist--></select></td><td style="padding-bottom:0px;text-align:center;" id="msgbox_0"><textarea name=msg_0 id=msg0 class='msg' rows=2 style='width:350px;padding:2px;' onfocus="hiliteme(0)"></textarea>
<<<<<<< HEAD
...
=======
</td><td align=center><select name=act_0 id=act0 onfocus="hiliteme(0)" style="width:60px" onchange='checkAction(0,this.selectedIndex)' onblur='document.getElementById("who0").focus()'><option>No<option>Yes</select><div id=actdiv0 class='actdiv'><button type=button style='display:inherit;' class='combut' onclick='markDone(0)'>Done</button></div></td><td><input type=text name=who_0 id=who0 size=9 style='text-align:center' placeholder='Callsign' onfocus="hiliteme(0)" onblur='if(this.value==""){this.value=prompt("What is your call sign?");}setCallSign(0,this.value);addRow(this.form);document.getElementById("who1").value=this.value;this.onBlur="";disableblur(this);document.getElementById("ts1").focus();'></td></tr>
<tr id=row1 valign=top><th id=rid1><input type=hidden name=ids[] value=1><input type=hidden name=msgstatus_1 id=msgstatus1 value=''>1</th><td><input type=text size=20 name=ts_1 id=ts1 onfocus="hiliteme(1)" onblur='getTimestamp(this.id);disableblur(this);' placeholder='TAB to Set'></td><td><select name=rxtx_1 class='px40' onfocus="hiliteme(1)"><option>Rx</option><option>Tx</option><option>Comment</option></select></td><td><input type=text name=loc_1 id=loc1 class='location' onfocus="hiliteme(1)"></td><td><select name=typ_1 id=typ1 class="typdd px80" onfocus="hiliteme(1)" onchange="checkType(this[this.selectedIndex].value,'loc1',0,encodeURIComponent(this.form.incidentid.value),this.form.stationid.value)"><!--$typlist--></select></td><td style="padding-bottom:0px;text-align:center;" id="msgbox_1"><textarea name=msg_1 id=msg1 class='msg' rows=2 style='width:350px;padding:2px;' onfocus="hiliteme(1)"></textarea></td><td align=center><select name=act_1 id=act1 onfocus="hiliteme(1)" style='width:60px' onchange='checkAction(1,this.selectedIndex)' onblur='document.getElementById("who1").focus()'><option>No<option>Yes</select><div id=actdiv1 class='actdiv'><button type=button style='display:inherit;' class='combut' onclick='markDone(1)'>Done</button></div></td><td><input type=text name=who_1 id=who1 size=9 style='text-align:center' placeholder='Callsign' onfocus="hiliteme(1)" onblur='if(this.value==""){this.value=prompt("What is your call sign?");}setCallSign(1,this.value);addRow(this.form);this.onBlur="";disableblur(this);document.getElementById("who2").value-this.value;document.getElementById("ts2").focus();';'></td></tr>
>>>>>>> e8c33dad0bd19cc606f6d6e81d7c1396c9fc9c1c
<?php
}
else {
